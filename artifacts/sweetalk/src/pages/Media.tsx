    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="sticky top-0 z-20 bg-background/80 backdrop-blur border-b border-border px-4 py-3 flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="font-semibold text-foreground">Shared Media</h1>
        </div>
      </div>
          ...
          <div className="max-w-3xl mx-auto p-4">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 text-center">
                ...
                <h3 className="font-semibold text-foreground mb-1">No media yet</h3>
                <p className="text-sm text-muted-foreground">Photos, videos, and voice notes will appear here</p>
              </div>
            ) : (
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
                {mediaItems.map((item) => (
                  <button
                    ...
                    className="aspect-square rounded-xl overflow-hidden bg-muted hover:opacity-90 transition-opacity relative group"
                  >
                    {item.type === "image" ? (
